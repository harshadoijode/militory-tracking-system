...
<form id="form1" name="form1" method="post" action="">
  <table style="background:black; color:white; border-radius:20px;" width="auto" border="0" align="center">
    <tr >
...
try{
int x=stmt.executeUpdate("insert into users(name,address,phone,password,email) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"')");
if(x!=0){
%>
<script>
